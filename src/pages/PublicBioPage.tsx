...
const AVAILABLE_ICONS = {
  instagram: <Instagram sx={{ fontSize: '28px' }} />,
  facebook: <Facebook sx={{ fontSize: '28px' }} />,
  twitter: <Twitter sx={{ fontSize: '28px' }} />,
  x: <SiX style={{ width: '28px', height: '28px' }} />,
  linkedin: <LinkedIn sx={{ fontSize: '28px' }} />,
  youtube: <YouTube sx={{ fontSize: '28px' }} />,
  tiktok: <SiTiktok style={{ width: '28px', height: '28px' }} />,
  threads: <SiThreads style={{ width: '28px', height: '28px' }} />,
  snapchat: <SiSnapchat style={{ width: '28px', height: '28px' }} />,
  whatsapp: <WhatsApp sx={{ fontSize: '28px' }} />,
  telegram: <Telegram sx={{ fontSize: '28px' }} />,
  github: <GitHub sx={{ fontSize: '28px' }} />,
  reddit: <Reddit sx={{ fontSize: '28px' }} />,
  pinterest: <Pinterest sx={{ fontSize: '28px' }} />,
  spotify: <SiSpotify style={{ width: '28px', height: '28px' }} />,
  discord: <SiDiscord style={{ width: '28px', height: '28px' }} />,
  twitch: <SiTwitch style={{ width: '28px', height: '28px' }} />,
  medium: <SiMedium style={{ width: '28px', height: '28px' }} />,
  buymeacoffee: <SiBuymeacoffee style={{ width: '28px', height: '28px' }} />,
  substack: <SiSubstack style={{ width: '28px', height: '28px' }} />,
  patreon: <SiPatreon style={{ width: '28px', height: '28px' }} />,
  kofi: <SiKofi style={{ width: '28px', height: '28px' }} />,
  email: <Email sx={{ fontSize: '28px' }} />,
  phone: <Phone sx={{ fontSize: '28px' }} />,
  store: <Store sx={{ fontSize: '28px' }} />,
  location: <LocationOn sx={{ fontSize: '28px' }} />,
  calendar: <CalendarMonth sx={{ fontSize: '28px' }} />,
  play: <PlayArrow sx={{ fontSize: '28px' }} />,
  news: <Newspaper sx={{ fontSize: '28px' }} />,
  shop: <Storefront sx={{ fontSize: '28px' }} />,
  payment: <Payments sx={{ fontSize: '28px' }} />,
  chat: <Message sx={{ fontSize: '28px' }} />,
  website: <Language sx={{ fontSize: '28px' }} />,
  globe: <Public sx={{ fontSize: '28px' }} />,
  code: <Code sx={{ fontSize: '28px' }} />,
  company: <Apartment sx={{ fontSize: '28px' }} />,
  blog: <MenuBook sx={{ fontSize: '28px' }} />,
  education: <School sx={{ fontSize: '28px' }} />,
  photo: <CameraAlt sx={{ fontSize: '28px' }} />,
  video: <Videocam sx={{ fontSize: '28px' }} />,
  link: <LinkIcon sx={{ fontSize: '28px' }} />
};
